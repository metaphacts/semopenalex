...
has_apc_list = URIRef("https://semopenalex.org/ontology/apcList")
has_apc_paid = URIRef("https://semopenalex.org/ontology/apcPaid")
                        ...
                        try:
                            ...
                            if not work_concepts is None:
                                for concept in work_concepts:
                                    ...
                                    g_rdf_star.write(f'<<<{work_uri}> <{has_concept_predicate}> <{concept_uri}>>> <{score_predicate}> "{concept_score}"^^<http://www.w3.org/2001/XMLSchema#decimal> .\n')
                            ...
                            if not work_keywords is None:
                                for keyword in work_keywords:
                                    ...
                                    # write rdf-star triples for keywords with scores in rdf-star file
                                    g_rdf_star.write(f'<<<{work_uri}> <{has_keyword_predicate}> <{keyword_uri}>>> <{score_predicate}> "{keyword_score}"^^<http://www.w3.org/2001/XMLSchema#decimal> .\n')
                            ...
                            if not work_primary_topic is None:
                                ...
                                # write rdf-star triples for primary_topic with scores in rdf-star file
                                g_rdf_star.write(f'<<<{work_uri}> <{has_primary_topic_predicate}> <{primary_topic_uri}>>> <{score_predicate}> "{primary_topic_score}"^^<http://www.w3.org/2001/XMLSchema#decimal> .\n')
                            ...
                            if not work_sustainable_development_goals is None:
                                for goal in work_sustainable_development_goals:
                                    ...
                                    # write rdf-star triples for sustainable_development_goals with scores in rdf-star file
                            ...
                            if not work_topics is None:
                                for topic in work_topics:
                                    ...
                                    # write rdf-star triples for topics with scores in rdf-star file
                                    g_rdf_star.write(f'<<<{work_uri}> <{has_topic_predicate}> <{topic_uri}>>> <{score_predicate}> "{topic_score}"^^<http://www.w3.org/2001/XMLSchema#decimal> .\n')
